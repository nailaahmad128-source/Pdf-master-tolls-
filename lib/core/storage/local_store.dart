...
class StoreKeys {
  ...
  static const savedSignatures = 'fillSign.savedSignatures';

  static const ocrHistory = 'history.ocr';

  // Per-tool history buckets. Each tool keeps its own independent log
  // rather than sharing a single combined bucket, so clearing or
  // reviewing one tool's history never touches another's.
  static const qrScanHistory = 'history.qrScan';
  static const qrGeneratedHistory = 'history.qrGenerated';
  static const mergeHistory = 'history.merge';
  static const splitHistory = 'history.split';
  static const compressHistory = 'history.compress';
  static const pdfToImageHistory = 'history.pdfToImage';
  static const imageToPdfHistory = 'history.imageToPdf';
}
