...
@immutable
class HistoryEntry {
  /// Separator used to join multiple output file paths into a single
  /// [payload] string for tools that produce more than one file per run
  /// (Split PDF, PDF to Image, ...). Chosen because it can't appear in a
  /// filesystem path.
